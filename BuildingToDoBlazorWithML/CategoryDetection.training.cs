...
namespace BuildingToDoBlazorWithML
{
    ...
    {
        public const string RetrainFilePath =  @"C:\projects\BuildingToDoBlazorWithML\BuildingToDoBlazorWithML\CategoryDetection.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Title",outputColumnName:@"Title")      
                                    ...
                                    .Append(mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options(){L1Regularization=0.03125F,L2Regularization=0.2280944F,LabelColumnName=@"Category",FeatureColumnName=@"Features"}));
